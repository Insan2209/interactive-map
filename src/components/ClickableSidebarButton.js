import CameraMovement from "../utility/CameraMovement";

function ClickableSidebarButton({img, text, color, x, y, zoom}) {
  return (
    //returns li (parent is ul) with button in it, button contains img and text from props
    <li className={"transition ease-in-out duration-500 mb-5 rounded-2xl list-none "+color} onClick={CameraMovement(x, y, zoom)}>
