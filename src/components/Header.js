function Header() {
    return (
        ...
        <div className="flex flex-wrap w-full h-16 bg-palette1-d">
            <img src="/img/Pirate's Isle Logo.png" alt="Pirate's Isle Logo" className="h-16 max-sm:h-10 p-2 my-auto"></img>
            <p className="font-semibold max-sm:text-xl text-2xl md:text-3xl p-1 my-auto text-palette1-a font-lacquer">Pirate's Isle</p>
